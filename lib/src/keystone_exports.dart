...
int KsVersion(Pointer<Uint32> major, Pointer<Uint32> minor) {
  _pfnKsVersion ??= _keystone?.lookupFunction<KsVersion_t, KsVersion_d>(_exportMap!['ks_version']!);
...
int KsOpen(int architecture, int mode, Pointer<IntPtr> engine) {
  _pfnKsOpen ??= _keystone?.lookupFunction<KsOpen_t, KsOpen_d>(_exportMap!['ks_open']!);
...
int KsClose(int engine) {
  _pfnKsClose ??= _keystone?.lookupFunction<KsClose_t, KsClose_d>(_exportMap!['ks_close']!);
...
Pointer<Utf8> KsStrError(int code) {
  _pfnKsStrError ??= _keystone?.lookupFunction<KsStrError_t, KsStrError_d>(_exportMap!['ks_strerror']!);
...
int KsErrno(int engine) {
  _pfnKsErrno ??= _keystone?.lookupFunction<KsErrno_t, KsErrno_d>(_exportMap!['ks_errno']!);
...
int KsOption(int engine, int type, int value) {
  _pfnKsOption ??= _keystone?.lookupFunction<KsOption_t, KsOption_d>(_exportMap!['ks_option']!);
  return _pfnKsOption!(engine, type, value);
}

typedef KsAsm_t = Uint32 Function(IntPtr, Pointer<Utf8>, Uint64, Pointer<IntPtr>, Pointer<IntPtr>, Pointer<IntPtr>);
typedef KsAsm_d = int Function(int, Pointer<Utf8>, int, Pointer<IntPtr>, Pointer<IntPtr>, Pointer<IntPtr>);
KsAsm_d? _pfnKsAsm;

int KsAsm(int engine, Pointer<Utf8> code, int baseAddress, Pointer<IntPtr> encoding, Pointer<IntPtr> size, Pointer<IntPtr> statements) {
  _pfnKsAsm ??= _keystone?.lookupFunction<KsAsm_t, KsAsm_d>(_exportMap!['ks_asm']!);
